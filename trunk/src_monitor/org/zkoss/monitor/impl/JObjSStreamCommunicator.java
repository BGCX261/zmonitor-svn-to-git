...
import org.zkoss.monitor.message.Callback;
...
public class JObjSStreamCommunicator implements Communicator {
	...
	/* (non-Javadoc)
	 * @see org.zkoss.monitor.message.Communicator#getTransmitter()
	 */
	...
	/* (non-Javadoc)
	 * @see org.zkoss.monitor.message.Communicator#getReceiever()
	 */
