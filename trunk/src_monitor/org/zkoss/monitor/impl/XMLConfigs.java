...
public class XMLConfigs {
	 ...
	 * @return
	 */
	public static <T> T newInstanceByClassAttr(Node node, Class<?> defaultClass, boolean mustHave){
	...
	public static <T> T newInstance(String clazzStr, Class<?> defaultClass){
		Class<?> clazz = null;
		try {
